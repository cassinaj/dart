...
void colorDataAssociation(uchar3* coloredAssociation,
                          ...
                          const int width,
                          const int height,
                          const uchar3 unassociatedColor = make_uchar3(0,
                                                                       0,
                                                                       0));

void colorDataAssociationMultiModel(
    uchar3* coloredAssociation,
    const int* dataAssociation,
    const uchar3** colors,
    const int width,
    const int height,
...
void getIndicesFromDataAssociationMultiModel(
    int2* modelSDFIndices,
    const int* dataAssociation,
    const int width,
    const int height,
